...
size_t fixed_index2_insert(fixed_index2_t *Store, void *Key);
size_t fixed_index2_search(fixed_index2_t *Store, void *Key);

index_result_t fixed_index2_insert2(fixed_index2_t *Store, void *Key);

const void *fixed_index2_get(fixed_index2_t *Store, size_t Index);
size_t fixed_index2_delete(fixed_index2_t *Store, void *Key);

...
linear_index0_t *linear_index0_open(const char *Prefix, void *Keys RADB_MEM_PARAMS);linear_index0_t *linear_index0_create(const char *Prefix, void *Keys RADB_MEM_PARAMS);

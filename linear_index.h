...
linear_index_t *linear_index_open(const char *Prefix, void *Keys RADB_MEM_PARAMS);linear_index_t *linear_index_create(const char *Prefix, void *Keys RADB_MEM_PARAMS);
